...
namespace FlutterBinding.UI
{
  ...
  public Radius operator %(double operand) => new Radius.elliptical(x % operand, y % operand);
    ...
    public class RRect
    {
        ...
        public RRect fromLTRBXY(double left, double top, double right, double bottom,
        ...
        public RRect fromLTRBR(double left, double top, double right, double bottom,
                        Radius radius)
        {
            _value
              ..[0] = left
        ...
        public RRect fromRectXY(Rect rect, double radiusX, double radiusY)
        {
            _value
              ..[0] = rect.left
              ..[1] = rect.top
        ...
        public RRect fromRectAndRadius(Rect rect, Radius radius)
        {
            _value
              ..[0] = rect.left
              ..[1] = rect.top
        ...
        public RRect fromLTRBAndCorners(
          double left,
          double top,
          double right,
          double bottom,
        ...
        ///
        /// The corner radii default to [Radius.zero], i.e. right-angled corners
        public RRect fromRectAndCorners(
          Rect rect,
            Radius topLeft = Radius.zero,
            Radius topRight = Radius.zero,
            Radius bottomRight = Radius.zero,
        ...
        public readonly List<double> _value = new List<float>(_kDataSize);
