...
public class RasterCacheResult
{
  ...
  public RasterCacheResult(sk_sp<SkImage> image, SkRect logical_rect)
  {
	  this.image_ = new sk_sp<SkImage>(std::move(image));
	  this.logical_rect_ = new SkRect(logical_rect);
  }
...
//C++ TO C# CONVERTER WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: void draw(SkiaSharp.SKCanvas& canvas, const SkPaint* paint = null) const
  public void draw(SkiaSharp.SKCanvas canvas, SkPaint paint = null)
  {
  ...
  private SkRect logical_rect_ = new SkRect();
}
...
//  public void Dispose();
  ...
  public static SkIRect GetDeviceBounds(SkRect rect, SkMatrix ctm)
  {
