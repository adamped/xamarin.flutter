...
//ORIGINAL LINE: void Paint(PaintContext& context) const override
  ...
  public override void UpdateScene(SceneUpdateContext context)
  {
	...
	scenic.Rectangle shape = new scenic.Rectangle(context.session(), clip_rect_.width(), clip_rect_.height());

	// TODO(liyuqian): respect clip_behavior_
	SceneUpdateContext.Clip clip = new SceneUpdateContext.Clip(context, shape, clip_rect_);
