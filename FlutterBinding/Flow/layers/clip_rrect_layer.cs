...
//ORIGINAL LINE: void Paint(PaintContext& context) const override
  ...
  public override void UpdateScene(SceneUpdateContext context)
  {
	...
	scenic.RoundedRectangle shape = new scenic.RoundedRectangle(context.session(), clip_rrect_.width(), clip_rrect_.height(), clip_rrect_.radii(SkRRect.Corner.kUpperLeft_Corner).x(), clip_rrect_.radii(SkRRect.Corner.kUpperRight_Corner).x(), clip_rrect_.radii(SkRRect.Corner.kLowerRight_Corner).x(), clip_rrect_.radii(SkRRect.Corner.kLowerLeft_Corner).x());

	// TODO(liyuqian): respect clip_behavior_
	SceneUpdateContext.Clip clip = new SceneUpdateContext.Clip(context, shape, clip_rrect_.getBounds());
